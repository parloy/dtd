                    ...
                    <div class="col-lg-6 order-1 order-lg-0">
                        <div class="registration-form">
                            ...
                            <div class="registration-form__wrapper">
                                <form action="signinserver.php" method="POST">
                                    <div class="input-field">
                                        <input type="text" placeholder="Username or email address" name="username" id="username" />
                                    ...
                                    <p class="text--body-3 registration-form__redirect">Don't Have Account ? <a href="index.php">Sign Up</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
